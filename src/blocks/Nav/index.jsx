...
export default function Nav() {
  return (
    <>
      ...
      <DesktopNav>
        <div>
          <Icon symbol="logo" colour="primary" size={64} />
          <Heading size="H2" align="left" colour="primary">
            Plantee
          </Heading>
        </div>
        <ul>
          <Link to="/">
            <li>
              <Icon symbol="tasks" colour="primary" size={36} />
              <Heading size="H4" align="left" colour="primary">
                Tasks
              </Heading>
            </li>
          </Link>
          ...
          <Link to="/settings">
            <li>
              <Icon symbol="settings" colour="primary" size={36} />
              <Heading size="H4" align="left" colour="primary">
                Settings
              </Heading>
            </li>
